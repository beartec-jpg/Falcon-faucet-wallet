...
export default function ScanPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      {/* ── Nav ──────────────────────────────────────────────────────────── */}
      <header className="border-b border-slate-800 px-4 py-3 flex items-center justify-between max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-brand-500 flex items-center justify-center text-slate-950 font-bold text-sm">Q</div>
          <div>
            <div className="font-semibold text-sm">{NETWORK_NAME}</div>
